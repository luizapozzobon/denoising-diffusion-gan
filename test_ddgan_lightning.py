...
from train_ddgan_lightning import DDGAN
...
def sample_and_test(args):
    ...
    if args.dataset == "cifar10":
        ...
        real_img_dir = "pytorch_fid/mnist_train_stat.npy"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="artifacts/model.ckpt")
